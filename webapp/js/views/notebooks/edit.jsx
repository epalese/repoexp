...
export default React.createClass({
            ...
            Actions.getNotebook(this.notebookId)
                .then(function (notebook) {
                    setTimeout(function () {
                        ...
                        this.initQuill(notebook.paragraphs);
                    }.bind(this), 2000);
                }.bind(this))
                ['catch'](function (err) {
    ...
    submit: function (e) {
        var notebookBody = this.quill.getHTML().replace(/data-reactid="[^"]+"/g, '')
        ...
        if(errors.length > 0) { 
            ...
            console.log(this.getInputEle('title').value);
            console.log(notebookBody);
            console.log(this.state.session.id);
            console.log(summary);
            Actions.modifyNotebook({
            ...
            .then(function (result) {
                ...
                this.history.pushState('', `/notebooks/${result.body.id}`);
            }.bind(this));
        }
    },
